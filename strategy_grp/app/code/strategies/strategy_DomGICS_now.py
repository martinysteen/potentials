...
dom_count_threshold of its tickers score below rank_threshold on priority_attribute
(longi_{priority_attribute}.csv, default "rank") THAT day. Dominating sectors contribute
their tickers_per_gics best tickers by info_attribute (longi_{info_attribute}.csv,
default "per1d"); the pool is re-ranked globally and focusset_size/from_rank applied.
