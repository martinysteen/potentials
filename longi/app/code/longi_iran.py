"""
Iran War Index Module

Calculates a price index relative to daynum 2094 (27 February 2026, the last
ordinary trading day before the Iran War). Index = price / price_at_origin.

Origin daynum 2094 = 1.0. Daynums older than origin are left empty.
...
OUTPUT_FILE = Path(__file__).parent.parent / "output" / "longi_iran.csv"
...
def main() -> int:
    print(f"Iran War Index (origin daynum {ORIGIN_DAYNUM})")
