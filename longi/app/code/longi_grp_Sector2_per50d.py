#!/usr/bin/env python3
"""
Sector2 sector-aggregated 50-day performance.
...
Writes:
- ../output/longi_grp_Sector2_per50d.csv

Rows are Sector2 names, columns are the daynums of longi_per50d.csv, each
...
def main() -> int:
    """Build longi_grp_Sector2_per50d.csv. Returns 0 on success, 1 on failure."""
