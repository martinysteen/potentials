...
# Keys listed in ascending day-count order (NOT alphabetical — "100d" < "10d" as a string).
BLANK_LEAD_COLS: dict[str, int] = {
    "longi_future_per1d.csv": 2,
    "longi_future_per5d.csv": 6,
    "longi_future_per10d.csv": 11,
    "longi_future_per20d.csv": 21,
...
EXPECTED_FILES: set[str] = {
    ...
    "longi_future_per20d.csv",
    "longi_future_per50d.csv",
    "longi_future_per100d.csv",
    "longi_future_per200d.csv",
    "longi_grp_GICS_per1d.csv",
    "longi_grp_GICS_per5d.csv",
    "longi_grp_GICS_per10d.csv",
    "longi_grp_GICS_per20d.csv",
    "longi_grp_GICS_per50d.csv",
    "longi_grp_GICS_per100d.csv",
    "longi_grp_GICS_per200d.csv",
    "longi_grp_Sector2_per1d.csv",
    "longi_grp_Sector2_per5d.csv",
    "longi_grp_Sector2_per10d.csv",
    "longi_grp_Sector2_per20d.csv",
    "longi_grp_Sector2_per50d.csv",
    "longi_grp_Sector2_per100d.csv",
    "longi_grp_Sector2_per200d.csv",
    "longi_iran.csv",
    "longi_ma10.csv",
    "longi_ma20.csv",
    "longi_ma50.csv",
    ...
    "longi_regr100d.csv",
    "longi_regr200d.csv",
    "longi_regrfit20d.csv",
    "longi_regrfit50d.csv",
    "longi_regrfit100d.csv",
    "longi_regrfit200d.csv",
    "longi_rsi.csv",
    "longi_sh1yr.csv",
    "longi_sh3m.csv",
    "longi_sh6m.csv",
