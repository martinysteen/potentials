#!/usr/bin/env python3
"""
Sector2 sector-aggregated 1-month performance.
...
Writes:
- ../output/longi_grp_Sector2_per1m.csv

Rows are Sector2 names, columns are the daynums of longi_per1m.csv, each
...
def main() -> int:
    """Build longi_grp_Sector2_per1m.csv. Returns 0 on success, 1 on failure."""
