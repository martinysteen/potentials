"""
Future Gain 50-Day Calculation Module

Calculates forward-looking 50-day percentage gains for backtesting.
...
This is "foresight" data - the gain that WILL happen over the next 50 days.
Useful for backtesting strategies by seeing what would have happened.

Array layout: [0]=newest (e.g., 2009), [n-1]=oldest (e.g., 1543)
For future gain at index i, we compare with index i-50 (newer/future price).

Formula: ((future_price - current_price) / current_price) * 100

Output: future_gain50d.csv
- First 50 columns (from left) are empty (no future data available)
"""
...
OUTPUT_FILE = OUTPUT_DIR / "future_gain50d.csv"
