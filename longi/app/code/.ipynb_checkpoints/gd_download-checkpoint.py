...
LONGI_ROOT = os.path.dirname(os.path.dirname(SCRIPT_DIR))  # Go up from code/ to app/ to longi/
SHARED_CREDS_DIR = os.path.join(os.path.dirname(LONGI_ROOT), 'shared', 'app', 'creds')
