"""
GICS 3-Month Sector Performance per Ticker Module

Expands sector-aggregated 3-month performance (from longi_grp_GICS_3m.csv) back to
...
Depends on: longi_grp_GICS_3m.py (needs longi_grp_GICS_3m.csv)
Reads Stamdata.csv and longi_grp_GICS_3m.csv, outputs longi_GICS_3m.csv.
...
GRP_FILE = Path(__file__).parent.parent / "output_grp" / "longi_grp_GICS_3m.csv"
OUTPUT_FILE = Path(__file__).parent.parent / "output" / "longi_GICS_3m.csv"
...
def main() -> int:
    ...
    """
    print("GICS 3-month sector performance per ticker")
