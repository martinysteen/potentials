...
4. Results go to `./app/output/` (individual stock tables) and `./app/output_grp/` (aggregated tables)
...
- Automatically discovers available output files (scans output/ and output_grp/ directories)
...
- ✓ longi_upload.py fully implemented
  - Uses rclone sync to upload output/, output_grp/, and across/ directories
