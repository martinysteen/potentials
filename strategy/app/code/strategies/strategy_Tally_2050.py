"""
Strategy: Tally_2050 — the 3-step Tally group build:
...
then pick the survivors with the HIGHEST MA20/MA50 speed quotient (chooser =
longi_quot2050; strongest sandbox result at the 50d horizon — see report 6k).
...
main, build_extension = make_strategy(STRATEGY_NAME, PARAMS, FILTERS,
                                      ranker=rank_by("longi_quot2050.csv", ascending=False),
                                      trims=TRIMS)
